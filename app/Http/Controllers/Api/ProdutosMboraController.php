...
class ProdutosMboraController extends BaseController
{
    public function index() {
        ...
        $produtos = DB::table('produtos_mbora as pm')
            ...
            ->select('pm.id', 'pm.imei', 'pm.idcategoria', 'pm.nome', 'pm.preco', 'pm.quantidade', 'pm.urlImage', 'pm.codigoBarra', 'pm.tag', 'pm.visualizacao', 'pm.created_at', 'ct.imei', 'ct.empresa', 'ct.district', 'ct.street', 'ct.coordinate as company_coordinate', 'pv.nome as nomeProvincia', 'cm.nome as nomeCategoria')
